...
$fullpath = $installDirectory + "/$moduleName/" 

$moduleInfo = Test-ModuleManifest -Path ./$moduleName/$moduleName.psd1
...
Copy-Item "./$moduleName/*" -Destination $fullfolder -Recurse
